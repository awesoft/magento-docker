...
RUN apk add --no-cache jq curl nano rsync git zip unzip cronie openssh\
        ...
        php82-openssl php82-pdo_mysql php82-phar php82-simplexml php82-soap php82-sockets php82-sodium \
...
RUN addgroup -g 1000 -S app \
    ...
    && chown -R app:app /app /var/log/php* && chmod -R 755 /app
...
COPY --chown=root:root etc/php-conf.d/ /etc/php82/conf.d/
